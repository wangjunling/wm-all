...
public class SystemUtil {
	...
	public static String get(final String key, String defaultValue) {
		...
		try {
			...
			logger.warn("Unable to retrieve a system property '{}'; default values will be used,key {}, e : {}",key, e);
		}
	...
	public static Properties props() {
		...
		try {
			...
			logger.warn("Unable to retrieve a system propertys; default values will be used.",e);
		}
		return props;
	}
