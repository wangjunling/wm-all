...
public class Validator {
    ...
    /** 邮编 */
    public final static Pattern ZIP_CODE             = Pattern.compile("/^[0-9]{6}$/");
    /** 邮编 */
    ...
    /**
     * 验证邮箱, blankValidate 为false时, 如果value为空返回true
     * @param value
     * @param blankValidate value为空时, 是否验证
     * @return
     */
    public static boolean isEmail(String value, boolean blankValidate) {
        if (StringUtils.isBlank(value) && !blankValidate) {
            return true;
        }
