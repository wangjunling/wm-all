...
import site.wmblog.common.context.SpringContext;
import site.wmblog.common.util.CryptoUtil;
import site.wmblog.common.web.Cookies;
...
public class XUserSessionManager {
    ...
    public static XUserSession initXUserSession() {
        ...
        if (StringUtils.isNotBlank(name)) {
            ...
            if (StringUtils.isNotBlank(password)) {
                password = CryptoUtil.decryptAES(password, Constant.COOKIE_CRYPTO_PASS);
    ...
    public static void setCookies(XUserSession xUserSession) {
        ...
        if (xUserSession.getXUser().getIsSavePass()) {
            ...
            Cookies.setCookie(XUSER_PASS_KEY, StringUtils.EMPTY);
        }
    }
