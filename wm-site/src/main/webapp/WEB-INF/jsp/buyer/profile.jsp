...
<form method="post" id="form">
    <div class="rcontbg fr">
        <div class="newtabs proftab">
            <div class="nav">
                <ul class="left-nav">
                    <li><a href="javascript:void(0)" class="curtab"> 个人信息 </a></li>
                ...
                <div class="sub-con cur-sub-con">
                    <div class="infoform clearfix">
                        ...
                        <div class="formcont fl">
                            <span class="formtxt"> <c:out value="${buyer.account}"/> </span>
                        </div>
                    </div>
                    <div class="infoform clearfix">
                        <div class="formtit fl"> 用户姓名</div>
                        <div class="formcont fl">
                            <span class="formtxt"> <c:out value="${buyer.contact}"/> </span>
                        </div>
                    </div>
                    <div class="infoform clearfix">
                        <div class="formtit fl"> 手机号</div>
                        <div class="formcont fl">
                            <span class="formtxt"> <c:out value="${buyer.phone}"/> </span>
                        </div>
                    </div>
                    <div class="infoform clearfix">
                        <div class="formtit fl"> 邮箱</div>
                        <div class="formcont fl">
                            <span class="formtxt"> <c:out value="${buyer.email}"/> </span>
                        </div>
                    </div>
                </div>
                <div class="sub-con">
                    ...
                    <div class="infoform clearfix">
                        ...
                        <div class="formcont fl">
                            <div class="iptwrp clearfix">
                                <input type="text" class="profmipt fl" name="registeredCapital" value="<c:out value='${buyer.registeredCapitalFormat}'/>"/>
                    ...
                    <div class="infoform clearfix">
                        ...
                        <div class="formcont fl uploader-wrap">
                            <div class="iptwrp clearfix">
                                ...
                                <a class="uploader-delete"> &times; </a>
                    ...
                    <div class="infoform clearfix">
                        <div class="formtit fl"> 审核状态</div>
                        <div class="formcont fl">
                            <span class="formtxt"> <c:out value="${buyer.stateText}"/> </span>
                        </div>
                    </div>

                    <div class="infoform clearfix">
                        <div class="formtit fl"> 审核备注</div>
                        <div class="formcont fl">
                            <span class="formtxt"><c:out value="${buyer.remark}"/></span>
                        </div>
                    </div>
                    ...
                    <div class="infoform clearfix">
                        ...
                        <div class="formcont fl">
                            <a class="btnsubmit" id="submit"> 立即提交 </a>
                        </div>
                    </div>
...
<%--<script type="text/javascript" src="/resources/js/plugins/jq-stab.js"></script>--%>
...
<script type="text/javascript" src="/resources/js/app/profile.js"></script>
